...
def first_setup():
    ...
    print "Take good note of the secret key and of the access key id. You also need to grant the permissions 'AmazonEC2FullAccess' and 'AmazonElasticFileSystemFullAccess' to that user."
    ...
    print "###################################################################"
    print "The configuration files have been created in '<HOME>/.aws'. If you have granted the permissions to the user, you're ready to run the script again."
    print "###################################################################\n\n"
    print USAGE
